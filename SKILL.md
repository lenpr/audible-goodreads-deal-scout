...
```bash
"{baseDir}/scripts/audible-goodreads-deal-scout.sh" prepare --config-path "<config-path>" --invocation-mode manual
```
...
```bash
"{baseDir}/scripts/audible-goodreads-deal-scout.sh" setup \
...
```bash
"{baseDir}/scripts/audible-goodreads-deal-scout.sh" finalize \
...
```bash
"{baseDir}/scripts/audible-goodreads-deal-scout.sh" run-and-deliver \
  --config-path "<config-path>" \
  --prepare-json "<prepare-result-path>" \
  --runtime-output "<runtime-output-path>"
```
...
```bash
"{baseDir}/scripts/audible-goodreads-deal-scout.sh" mark-emitted --state-file "<state-file>" --deal-key "<deal-key>"
```
